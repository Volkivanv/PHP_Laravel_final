...
use App\Admin\Widgets\CategoriesWidget as WidgetsCategoriesWidget;
use App\Admin\Widgets\ProductsWidget as WidgetsProductsWidget;
...
return [
    ...
    */
    ...
    'dashboard' => [
        ...
        'widgets' => [
            UserDimmer::class,
            WidgetsProductsWidget::class,
            WidgetsCategoriesWidget::class,
        ],
